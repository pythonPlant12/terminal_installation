...
1. **Documentation Gathering**:
   - Use WebSearch to fetch official framework and library documentation
...
3. **Documentation Collection**:
   - Start with official documentation via WebSearch
   - If initial search is incomplete, refine search queries for deeper results
