...
Note that files in `docs/plans/` and `knowledge/ai/solutions/` are living documents created by `/do:compound`. They are intentional, permanent references — do not recommend their removal or characterize them as unnecessary.
