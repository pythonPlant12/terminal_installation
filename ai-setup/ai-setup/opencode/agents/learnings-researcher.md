---
description: Searches knowledge/ai/solutions/ for relevant past solutions by frontmatter metadata. Use before implementing features or fixing problems to surface institutional knowledge and prevent repeated mistakes.
mode: subagent
...
assistant: "I'll use the learnings-researcher agent to check knowledge/ai/solutions/ for any relevant learnings about email processing or brief system implementations."
...
The `knowledge/ai/solutions/` directory contains documented solutions with YAML frontmatter. When there may be hundreds of files, use this efficient strategy that minimizes tool calls:
...
| ---------------- | ---------------------------------------------------------------- |
| Performance work | `knowledge/ai/solutions/performance-issues/`                             |
| Database changes | `knowledge/ai/solutions/database-issues/`                                |
| Bug fix          | `knowledge/ai/solutions/runtime-errors/`, `knowledge/ai/solutions/logic-errors/` |
| Security         | `knowledge/ai/solutions/security-issues/`                                |
| UI work          | `knowledge/ai/solutions/ui-bugs/`                                        |
| Integration      | `knowledge/ai/solutions/integration-issues/`                             |
| General/unclear  | `knowledge/ai/solutions/` (all)                                          |
...
Grep: pattern="title:.*email" path=knowledge/ai/solutions/ output_mode=files_with_matches -i=true
Grep: pattern="tags:.*(email|mail|smtp)" path=knowledge/ai/solutions/ output_mode=files_with_matches -i=true
Grep: pattern="module:.*(Brief|Email)" path=knowledge/ai/solutions/ output_mode=files_with_matches -i=true
Grep: pattern="component:.*background_job" path=knowledge/ai/solutions/ output_mode=files_with_matches -i=true
```
...
```bash
Grep: pattern="email" path=knowledge/ai/solutions/ output_mode=files_with_matches -i=true
```
...
```bash
Read: knowledge/ai/solutions/patterns/critical-patterns.md
```
...
- **File**: knowledge/ai/solutions/[category]/[filename].md
...
Reference the [yaml-schema.md](../../skills/do-compound/references/yaml-schema.md) for the complete schema. Key enum values for frontmatter fields:
...
- `knowledge/ai/solutions/build-errors/`
- `knowledge/ai/solutions/test-failures/`
- `knowledge/ai/solutions/runtime-errors/`
- `knowledge/ai/solutions/performance-issues/`
- `knowledge/ai/solutions/database-issues/`
- `knowledge/ai/solutions/security-issues/`
- `knowledge/ai/solutions/ui-bugs/`
- `knowledge/ai/solutions/integration-issues/`
- `knowledge/ai/solutions/logic-errors/`
- `knowledge/ai/solutions/developer-experience/`
- `knowledge/ai/solutions/workflow-issues/`
- `knowledge/ai/solutions/best-practices/`
- `knowledge/ai/solutions/documentation-gaps/`
...
- `/gsd-plan-phase` - To inform planning with institutional knowledge
- `/deepen-plan` - To add depth with relevant learnings
- `/do:review` - Hardwired (always runs regardless of review config)
- `/root-cause-analysis` - Mandatory step 3 before code investigation begins
- Manual invocation before starting work on a feature

See also: `opencode/rules/learnings-researcher-mandate.md` for the global mandate policy.
