...
input: Frontend requirement (component, page, or application) with optional purpose, audience, and constraints
output: Production-grade frontend code with distinctive design direction, avoiding generic AI aesthetics
category: frontend
---
