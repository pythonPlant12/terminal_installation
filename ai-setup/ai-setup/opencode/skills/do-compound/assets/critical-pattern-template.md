...
Use this template when adding a pattern to `knowledge/ai/solutions/patterns/critical-patterns.md`:
...
**Documented in:** `knowledge/ai/solutions/[category]/[filename].md`
