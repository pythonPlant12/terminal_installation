...
|------|----------|---------------------|
| **API/Service** | manage-stripe, manage-gohighlevel | WebSearch |
| **CLI Tools** | build-macos-apps (xcodebuild, swift) | Run commands |
| **Framework** | build-iphone-apps (SwiftUI, UIKit) | WebSearch for docs |
| **Integration** | setup-stripe-payments | WebFetch + WebSearch |
...
Use WebSearch to fetch current documentation:
```
Search for: "{service-name} official documentation"
Search for: "{service-name} API reference [current year]"
```
...
Use WebSearch:
```
Search for: "{framework-name} official documentation"
Search for: "{framework-name} API reference {specific-api}"
```
...
Then WebSearch for current SDK patterns.
...
**WebSearch pattern for any library:**
```
1. Search: "{library-name} official documentation"
2. Search: "{library-name} API reference {specific-feature}"
```
