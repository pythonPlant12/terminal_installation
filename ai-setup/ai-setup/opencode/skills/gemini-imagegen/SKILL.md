...
input: Text prompt for image generation, or existing image with edit instructions
output: Generated or edited image via Gemini API (text-to-image, style transfer, multi-turn refinement)
