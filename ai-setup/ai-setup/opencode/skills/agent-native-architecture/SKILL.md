...
input: System design requirement or agent architecture question
output: Architecture guidance with agent loop patterns, MCP tool designs, and implementation strategy
