...
input: Brainstorm or plan document to refine before the next workflow step
output: Improved document with structural, clarity, and completeness suggestions applied
...
If invoked within a workflow (after a brainstorm or plan document exists), also check:
