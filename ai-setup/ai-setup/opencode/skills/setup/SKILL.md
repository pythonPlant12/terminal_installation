---
name: setup
description: Configure which review agents run for your project. Auto-detects stack and writes project-review-config.md.
disable-model-invocation: true
input: Project to configure for code review agents (auto-detects stack)
output: project-review-config.md with configured review agents, plan agents, and review context
category: integration
---

# Review Agent Setup

Interactive setup for `project-review-config.md` — configures which agents run during `/do:review`.

## Step 1: Check Existing Config

Read `project-review-config.md` in the project root. If it exists, display current settings summary and use AskUserQuestion:
...
Write `project-review-config.md`:
...
These notes are passed to all review agents during /do:review.
...
```
Saved to project-review-config.md
