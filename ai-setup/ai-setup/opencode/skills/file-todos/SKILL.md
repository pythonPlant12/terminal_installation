...
input: Todo action (create, triage, update status, check dependencies) or PR feedback to track
output: Managed todo markdown files in todos/ directory with YAML frontmatter and lifecycle tracking
