...
input: Worktree action (create, list, switch, cleanup) with optional branch name or PR reference
output: Managed git worktree for isolated parallel development with status tracking
category: git
---
...
2. **Feature Work**: Always ask if user wants parallel worktree or live branch work
...
The skill is automatically called from `/do:review` command:
