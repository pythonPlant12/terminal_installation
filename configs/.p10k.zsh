# Generated by Powerlevel10k configuration wizard on 2024-07-04 at 21:06 CEST.
# Based on romkatv/powerlevel10k/config/p10k-classic.zsh, checksum 34817.
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIINS_CONTENT_EXPANSION=' 󰛂'
  ...
  typeset -g POWERLEVEL9K_DIR_FOREGROUND='#de8621'
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND='#de5321'
  # Color of the anchor directory segments. Anchor segments are never shortened. The first
  # segment is always an anchor.
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND='#de5321'
  ...
  # Custom icon.
  typeset -g POWERLEVEL9K_TIMEWARRIOR_VISUAL_IDENTIFIER_EXPANSION='󱑒'
